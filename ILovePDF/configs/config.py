...
# If you prefer using a local `.env` file during development, try to load it
# (optional dependency). This keeps production deployments unchanged.
try:
...
class bot(object):
    ...
    API_ID: int = int(os.environ.get("API_ID", 0)) if os.environ.get("API_ID") else 0
