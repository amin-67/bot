...
async def _refresh(bot, callbackQuery):
    try:
        ...
        if callbackQuery.data.startswith("refresh-g"):  # this means "refresh-g{code}
            ...
            await util.disable_buttons_and_notify(callbackQuery.message)
            return
        ...
        elif callbackQuery.message.reply_to_message and getattr(callbackQuery.message.reply_to_message, 'document', None):
            await util.disable_buttons_and_notify(callbackQuery.message)
            return await documents(bot, callbackQuery.message.reply_to_message)

        elif callbackQuery.message.reply_to_message and getattr(callbackQuery.message.reply_to_message, 'photo', None):
            await util.disable_buttons_and_notify(callbackQuery.message)
            ...
            await util.try_delete_message(callbackQuery.message.reply_to_message)
            return

        elif callbackQuery.message.reply_to_message and getattr(callbackQuery.message.reply_to_message, 'text', '').startswith("/"):
            await util.disable_buttons_and_notify(callbackQuery.message)
            return await gDOC(bot, callbackQuery.message.reply_to_message)

        elif callbackQuery.message.reply_to_message and getattr(callbackQuery.message.reply_to_message, 'text', None):
            await util.disable_buttons_and_notify(callbackQuery.message)
